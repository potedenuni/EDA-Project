...
sulphate levels, one would expect to see a definitive graduation from black
to red within a vertical cross section of differenct levels of sulphates.
However, the distribution of red and black does not appear to show any pattern.
Therefore, the addition of the citric acid variable within the analysis of 
sulphates and quality does not appear to enhance any correlations.
...
Noticing that there are very few values of citric acid above, 0.75, I will 
eliminate these aoutliers to enhance the main area of focus.

```{r echo=FALSE, message=FALSE, warning=FALSE, Multivariate_Plots2.1}
...
Again, in analyzing these charts, if sulphates had an impact on quality at
different citric acid levels, one would expect to see a definitive graduation 
from black to red within a vertical cross section of differenct levels of citric
acid.

However, the distribution of red and black does not appear to show any pattern.
Therefore, the addition of the sulphates variable within the analysis of 
citric acid and quality does not appear to enhance any correlations.
...
Reviewing this chart, I do not see that varying volatile acidity for a given
citric acid level will have a significant impact on the quality.  I do, however,
recognize the inverse correlation between these two values.  One will notice
that for the lower levels of citric acid, there is more red in the chart
(indicating higher volatile acidity) and toward the higher levels of citric acid
there is less red and more black (indicating lower volatile acidity).
...
Once again, this analysis fails to produce a notable impact of citric acid
levels at any given level of alcohol.
